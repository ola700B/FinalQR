    ...
    resources: {
      en: {
        translation: {
          ...
          sand: "Sand",
          parsley: "Parsley",
          quiz_q1: "Which plant is known for producing olives and olive oil?",
          quiz_q2:
            "Which part of a plant is mainly responsible for absorbing water?",
          quiz_q3: "What is the main green pigment in plant leaves?",
          quiz_q4: "Which plant organ is responsible for photosynthesis?",
          quiz_q5: "What do plants need to make their own food?",
          quiz_q6: "Which tree can live for hundreds of years?",
          lives: "Lives",
          mistakes: "Mistakes",
          time: "Time",
          score: "Score",
...
الجذور: حمراء داكنة أو بيضاء أو صفراء، وقد تكون ليفية أو سميكة أو منتفخة.`,
          ...
          plant_silq_propagation:
            "يتكاثر حصريًا تقريبًا بالبذور، حيث تُزرع الأصناف التجارية مباشرة في الحقول. وهو نبات ثنائي الحول، إذ يُنتج البذور في السنة الثانية بعد التعرض للبرودة، ولا يُستخدم فيه الإكثار الخضري بشكل عام، لذا تبقى البذور الوسيلة الأساسية للإكثار.",
          ...
          quiz_q1: "أي نبات يُعرف بإنتاج الزيتون وزيت الزيتون؟",
          quiz_q2: "أي جزء من النبات مسؤول بشكل أساسي عن امتصاص الماء؟",
          quiz_q3: "ما الصبغة الخضراء الرئيسية في أوراق النباتات؟",
          quiz_q4: "أي عضو نباتي مسؤول عن عملية البناء الضوئي؟",
          quiz_q5: "ماذا تحتاج النباتات لتصنع غذاءها بنفسها؟",
          quiz_q6: "أي شجرة يمكن أن تعيش لمئات السنين؟",
